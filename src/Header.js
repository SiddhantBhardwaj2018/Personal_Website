        ...
        <div className="container">
          ...
          <h3 class="intro__contact">
            ...
            <span>
              {" "}
              <a
                href="mailto:bhardwajsiddhant03@gmail.com"
                target="_blank"
                class="highlight-link"
              >
                bhardwajsiddhant03@gmail.com
              </a>{" "}
            </span>{" "}
          </h3>{" "}
          <h3 class="intro__contact">
            ...
            <span>
              {" "}
              <a
                href="https://drive.google.com/file/d/1LhvL3-iYaDdnFzeTKhfUzszmbIB1C10-/view?usp=sharing"
                target="_blank"
                class="highlight-link"
              >
                View My Resume
